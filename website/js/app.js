...
const OPTIMIZED_DOWNLOAD_BASE =
  "https://github.com/chmoralla-code/HORMACHUELOS-OPTIMIZED/releases/download/v1.3.7";

const OPTIMIZED_DOWNLOADS = {
  version: "1.3.7",
  releaseNotes: "https://github.com/chmoralla-code/HORMACHUELOS-OPTIMIZED/releases/tag/v1.3.7",
  windows: {
    msi: {
      label: "Optimized installer (MSI)",
      href: `${OPTIMIZED_DOWNLOAD_BASE}/Hormachuelos_Optimized_1.3.7_x64.msi`,
    },
    setup: {
      label: "Optimized setup (EXE)",
      href: `${OPTIMIZED_DOWNLOAD_BASE}/Hormachuelos_Optimized_1.3.7_x64-setup.exe`,
    },
  },
};
  ...
  const wrap = page(`
    <div class="prose container">
      ...
      <div class="card" id="optimized-download" style="margin:20px 0;border-color:var(--primary)">
        ...
        <p class="muted small">v1.3.7 maximizes each software mode with a sharp job and recommended high-signal replies. Ask answers, Plan plans, Research cites evidence, and Build reports what shipped. Adaptive remains the default, AGENTIC stays opt-in, and this edition installs independently from the standard release.</p>
