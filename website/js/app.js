...
const OPTIMIZED_DOWNLOAD_BASE =
  "https://github.com/chmoralla-code/HORMACHUELOS-OPTIMIZED/releases/download/v1.3.6";

const OPTIMIZED_DOWNLOADS = {
  version: "1.3.6",
  releaseNotes: "https://github.com/chmoralla-code/HORMACHUELOS-OPTIMIZED/releases/tag/v1.3.6",
  windows: {
    msi: {
      label: "Optimized installer (MSI)",
      href: `${OPTIMIZED_DOWNLOAD_BASE}/Hormachuelos_Optimized_1.3.6_x64.msi`,
    },
    setup: {
      label: "Optimized setup (EXE)",
      href: `${OPTIMIZED_DOWNLOAD_BASE}/Hormachuelos_Optimized_1.3.6_x64-setup.exe`,
    },
  },
};
  ...
  const wrap = page(`
    <div class="prose container">
      ...
      <div class="card" id="optimized-download" style="margin:20px 0;border-color:var(--primary)">
        ...
        <p class="muted small">v1.3.6 keeps every step of a run on the record—status and reasoning steps now persist as a compact step log under your message instead of being replaced as work progresses. Adaptive remains the default, and this edition installs independently from the standard release.</p>
