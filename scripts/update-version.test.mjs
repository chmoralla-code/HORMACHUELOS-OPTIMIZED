...
test("treats revision builds as newer than the same three-part version", () => {
  ...
  assert.equal(isVersionNewer("1.3.1", "1.3.0"), true);
  assert.equal(isVersionNewer("1.3.0", "1.3.1"), false);
  assert.equal(isVersionNewer("1.3.2", "1.3.1"), true);
  assert.equal(isVersionNewer("1.3.1", "1.3.2"), false);
  assert.equal(isVersionNewer("1.3.3", "1.3.2"), true);
  ...
  assert.equal(isVersionNewer("1.3.6", "1.3.5"), true);
  assert.equal(isVersionNewer("1.3.5", "1.3.6"), false);
  assert.equal(isVersionNewer("1.3.7", "1.3.6"), true);
  assert.equal(isVersionNewer("1.3.6", "1.3.7"), false);
