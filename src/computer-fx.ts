...
function ensureOverlay(): void {
  ...
  style.textContent = `
    ...
    #__horma-ai-target-label{position:absolute;right:12px;top:10px;z-index:1;padding:3px 7px;border-radius:999px;background:#07121ef2;color:#f4f4f4;border:1px solid rgba(255,255,255,.42);font:800 9px/1 ui-monospace,SFMono-Regular,Consolas,monospace!important;letter-spacing:.08em}
